"""rebuild photo_embeddings schema on top of 013

Revision ID: 014_fix_photo_embeddings
Revises: 013_add_app_settings
...
revision: str = "014_fix_photo_embeddings"
down_revision: Union[str, None] = "013_add_app_settings"
